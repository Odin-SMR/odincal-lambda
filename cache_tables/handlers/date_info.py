...
def gen_data(connector, query_string):
    con = connector()
...
def get_date_info(connector, date: dt.date | dt.datetime):
    ...
    query_str = gen_query(stw_start, stw_end, mjd_start, mjd_end)
    return gen_data(connector, query_str)
...
def update_measurements(
    ...
    while current_date >= earliest_date:
        date_info = get_date_info(current_date)
